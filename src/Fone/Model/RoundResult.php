...
class RoundResult extends AbstractModel
{
    ...
    public function getScore(&$breakdown)
    {
        ...
        $racePoints = [50, 45, 40, 35, 30, 27, 24, 22, 20, 18, 16, 14, 13, 12, 11, 10, 9, 8, 7, 6, 5, 4];
        $qualiPoints = array_reverse(range(4, 25));
        $breakdown['race'] = $racePoints[$this->getRacePosition() - 1 ];
        $breakdown['quali'] = $qualiPoints[$this->getQualifyingPosition() -1 ];
